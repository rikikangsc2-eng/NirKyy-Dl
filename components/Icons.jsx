/*
* Lokasi: components/Icons.jsx
* Versi: v6
*/

export const IconDownloader = () => (
...
export const IconGame = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6.38 2.65a2 2 0 0 1 1.63.3l11.45 8.18a2 2 0 0 1 0 3.73L8.01 23.05a2 2 0 0 1-3.18-1.87V4.82a2 2 0 0 1 1.55-2.17z" /></svg>
);

export const IconParameters = () => (
